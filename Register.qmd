...
*Note that Zoom Events excludes some countries from processing event payments, though attendance is still permitted. If you are registering from country where payment is blocked (see the list at Zoom Events [here](https://support.zoom.com/hc/en/article?id=zm_kb&sysparm_article=KB0063856)) please email r-medicine\@r-consortium.org to request a manual registration. All are welcome at R/Medicine!*
...
Tell us why you need one of the limited number of complimentary registrations. Limit 500 characters. **Submissions are now closed.**

<!-- Submit [here](https://docs.google.com/forms/d/e/1FAIpQLSdGQ_QqQdOmAvuT_1oLMC_LFVgWeq3NBJ013tVJizklv4bm5g/viewform?usp=header). -->
